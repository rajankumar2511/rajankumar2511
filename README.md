...
⚡ Real-Time & Distributed Systems enthusiast
🌐 MERN + PERN Stack Developer
🏗️ Interested in System Design & Scalable Architecture
🚀 Building reliable, high-performance applications
```

I build backend-heavy applications with a focus on **scalability, concurrency, reliability, real-time communication, and distributed architecture**.
...
| ⚡ Real-Time | 🌐 Distributed Systems | 💻 Full Stack |
|:---:|:---:|:---:|
| WebSockets | Event-Driven Architecture | MERN |
| Socket.IO | Redis Pub/Sub | PERN |
| WebRTC | Message Queues | Next.js |
| Real-Time Chat | Distributed Locking | REST APIs |
| Video Calling | Background Workers | Authentication |
...
**Node.js • Express.js • React • Socket.IO • WebRTC • Redis**
...
- 📁 Media sharing
- 🟢 Real-time presence
- ⚡ Redis-backed real-time architecture

### 🏥 MediSlot

**Node.js • Express.js • React • PostgreSQL • Prisma • Redis • BullMQ**
